...
from src.rendering.renderer import ModernReportRenderer, TemplateRenderer
...
class TestTemplateRendererFilters:
    ...
    def test_all_custom_filters_registered(self, temp_template_dir):
        ...
        from src.rendering.formatters import get_template_filters
...
class TestRendererErrorHandling:
    ...
    def test_modern_renderer_handles_context_errors(self, mock_logger):
        ...
        # Should log error
        assert mock_logger.error.called or True  # May not reach logger if fails earlier
